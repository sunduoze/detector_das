...
void setup(void)
{
  ...
  xTaskCreatePinnedToCore(xTask_dbgx, "Task_dbgx", 4096, NULL, 5, NULL, PINNED_TO_CORE1);
  xTaskCreatePinnedToCore(xTask_rotK, "Task_rotK", 4096, NULL, 4, NULL, PINNED_TO_CORE1);
}
